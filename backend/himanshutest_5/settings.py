"""
Django settings for himanshutest_5 project.
...
ROOT_URLCONF = 'himanshutest_5.urls'
...
WSGI_APPLICATION = 'himanshutest_5.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "himanshutest Support <support@himanshutest-5.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himanshutest_5 API",
    "DESCRIPTION": "API documentation for himanshutest_5 App",
    "VERSION": "v1",
}
